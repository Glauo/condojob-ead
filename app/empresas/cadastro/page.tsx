    ...
    <div className="login-page">
      <div className="login-left">
        ...
        <div className="login-left-inner">
          ...
          <h1 className="login-left-title">Cadastro da empresa<br /><span className="login-left-title-accent">Publique vagas direto na CondoJob.</span></h1>
          <p className="login-left-desc">Crie o acesso da empresa ou condominio para cadastrar vagas, informar disponibilidade e receber aceite dos trabalhadores na plataforma.</p>
        </div>
      </div>
      <div className="login-right">
        <div className="login-right-orb login-right-orb-1" />
        <div className="login-right-orb login-right-orb-2" />
        <JobsAuthForm perfil="company" modo="register" />
      </div>
    </div>
  );
}
