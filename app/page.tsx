  ...
  return (
    <main className="landing-page">
      <section className="landing-hero">
        ...
        <div className="landing-hero-content">
          ...
          <div className="landing-hero-actions">
            <Link href="/cadastro" className="landing-primary-btn">Quero fazer minha matricula</Link>
      ...
      <section className="landing-section landing-course-strip" aria-label="Resumo do curso">
        ...
        <p>
          O aluno estuda por videoaulas, acessa materiais de apoio, responde avaliacoes por modulo
          e acompanha notas, certificado e comunicacao com a coordenacao dentro da plataforma.
        </p>
      </section>
      ...
      <section className="landing-section landing-offer" aria-label="Oferta do curso">
        <div className="landing-offer-copy">
          ...
          <p>
            ...
            Apos o cadastro, o aluno segue automaticamente para o pagamento.
          </p>
        </div>
