...
const ALUNO_NAV: NavItem[] = [
  ...
  { label: "Especializações", href: "/aluno/especializacoes", icon: <NavIcon d="M11 17a1 1 0 102 0v-1.586l.293.293a1 1 0 001.414-1.414L12 11.586l-2.707 2.707a1 1 0 101.414 1.414L11 15.414V17zM4 4a2 2 0 012-2h7a3 3 0 013 3v4a1 1 0 11-2 0V5a1 1 0 00-1-1H6v12h2a1 1 0 110 2H6a2 2 0 01-2-2V4z" /> },
...
const COORD_NAV: NavItem[] = [
  ...
  { label: "Conteúdo", href: "/coordenador/aulas", icon: <NavIcon d="M15 8a3 3 0 10-5.977-.75l-4.124 2.053a3 3 0 100 1.394l4.124 2.053A3 3 0 1015 12a3 3 0 00-1.977-2.83l-2.81 1.398A3.01 3.01 0 0010 11a2.99 2.99 0 00-.023-.17l2.834-1.41A2.992 2.992 0 0015 8z" /> },
