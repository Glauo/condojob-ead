...
const COORD_NAV: NavItem[] = [
  ...
  { label: "Aulas", href: "/coordenador/aulas", icon: <NavIcon d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" /> },
