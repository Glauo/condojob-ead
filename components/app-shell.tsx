...
const COORD_NAV: NavItem[] = [
  ...
  { label: "Comercial", href: "/comercial", icon: <NavIcon d="M2 5a2 2 0 012-2h8a2 2 0 012 2v1h1a3 3 0 013 3v5a3 3 0 01-3 3h-1v1a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm2 1v10h8V6H4zm11 4a1 1 0 100-2 1 1 0 000 2zm-8 1a1 1 0 100 2h2a1 1 0 100-2H7z" /> },
  { label: "Empregos", href: "/admin/oportunidades", icon: <NavIcon d="M11 17a1 1 0 102 0v-1.586l.293.293a1 1 0 001.414-1.414L12 11.586l-2.707 2.707a1 1 0 101.414 1.414L11 15.414V17zM4 4a2 2 0 012-2h7a3 3 0 013 3v4a1 1 0 11-2 0V5a1 1 0 00-1-1H6v12h2a1 1 0 110 2H6a2 2 0 01-2-2V4z" /> },
